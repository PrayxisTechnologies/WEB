...
export const COURSES_DATA: CourseProgram[] = [
  ...
  },
  {
    ...
    status: 'ACTIVE PROGRAM',
    isFeatured: true,
    description: 'Enterprise microservices, Next.js 14, GraphQL, Redis caching, CI/CD pipelines, and AWS cloud deployment.',
    technologies: ['NEXT.JS', 'MICROSERVICES', 'DOCKER', 'KUBERNETES', 'AWS', 'REDIS'],
    originalPrice: 1999,
    discountPrice: 149,
    offerTag: 'GANESH CHATURTHI OFFER',
    enrollUrl: '/student/profile',
  ...
  },
  {
    ...
    status: 'ACTIVE PROGRAM',
    isFeatured: false,
    description: 'Enterprise SOC monitoring, SIEM Splunk/ELK, Incident Response, Malware Analysis, and Threat Hunting.',
    technologies: ['SIEM / SPLUNK', 'ELK STACK', 'THREAT HUNTING', 'MALWARE ANALYSIS', 'INCIDENT RESPONSE'],
    originalPrice: 1999,
    discountPrice: 149,
    offerTag: 'GANESH CHATURTHI OFFER',
    enrollUrl: '/student/profile',
  ...
  },
  {
    ...
    status: 'ACTIVE PROGRAM',
    isFeatured: false,
    description: 'Autonomous multi-agent systems, LangChain/LangGraph, AutoGen, fine-tuning LLMs, and custom AI workforce agents.',
    technologies: ['LANGCHAIN', 'LANGGRAPH', 'AUTOGEN', 'LLM FINE-TUNING', 'VECTOR DB'],
    originalPrice: 1999,
    discountPrice: 149,
    offerTag: 'GANESH CHATURTHI OFFER',
    enrollUrl: '/student/profile',
  ...
  },
  {
    ...
    duration: '6 MONTHS',
    hours: '480 HOURS',
    level: 'EXECUTIVE / SPECIALIZATION',
    status: 'ACTIVE PROGRAM',
    isFeatured: true,
    description: 'Comprehensive 6-month industry mentorship & specialization in Cloud Native DevOps, Multi-Cloud Kubernetes, & Site Reliability Engineering.',
    technologies: ['MULTI-CLOUD', 'KUBERNETES', 'TERRAFORM', 'GITOPS', 'SRE'],
    originalPrice: 4999,
    priceHidden: true,
    offerTag: 'EXECUTIVE SPECIALIZATION',
    enrollUrl: '/student/profile',
    specs: {
      days: '180 DAYS',
      totalHours: '480 HOURS',
      dailyActiveTime: '3H 30M',
      format: 'EXECUTIVE MENTORSHIP',
    },
  },
  {
    id: 'executive-ai-6m',
    ...
    status: 'ACTIVE PROGRAM',
    isFeatured: false,
    description: '6-month intensive specialization in enterprise LLMOps, custom model distillation, distributed training, and AI security governance.',
    technologies: ['LLMOPS', 'DISTRIBUTED TRAINING', 'MODEL DISTILLATION', 'AI GOVERNANCE'],
    originalPrice: 4999,
    priceHidden: true,
    offerTag: 'EXECUTIVE SPECIALIZATION',
    enrollUrl: '/student/profile',
    specs: {
      ...
      totalHours: '480 HOURS',
      dailyActiveTime: '3H 30M',
      format: 'RESEARCH & INDUSTRIAL LAB',
    },
  },
];
